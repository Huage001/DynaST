...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='deepfashion', help='name of the experiment. It decides where to store samples and models')
    ...
    def parse(self, save=False):
        ...
        opt.gpu_ids = [int(idx) for idx in str_ids]
        seed = 1234
        random.seed(seed)
        np.random.seed(seed)
